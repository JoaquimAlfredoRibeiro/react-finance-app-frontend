...
import { init, create, put, remove } from '../billingCycle/billingCycleActions'
...
const mapDispatchToProps = dispatch => bindActionCreators({ init, create, put, remove }, dispatch)
